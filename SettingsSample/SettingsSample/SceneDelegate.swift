...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        // `scene`. If using a storyboard, the `window` property will automatically be initialized and attached to
        // the scene. This delegate does not imply the connecting scene or session are new (see
