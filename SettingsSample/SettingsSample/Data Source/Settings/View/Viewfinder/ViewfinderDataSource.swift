...
class ViewfinderDataSource: DataSource {
        ...
        return Section(title: "Rectangular", rows: [
                        Row.choice(title: "Style",
                                   ...
                                   didChangeValue: { value in
                                    ...
                                    switch value {
                                    case .square, .rounded:
                                        SettingsManager.current.viewfinderSizeSpecification = .widthAndHeightAspect
    ...
    lazy var laserlineWidth: Row = {
        return Row.valueWithUnit(title: "Width",
                                 ...
                                 didChangeValue: {
            var viewfinder = SettingsManager.current.viewfinder as! LaserlineViewfinder
            viewfinder.width = $0
            SettingsManager.current.viewfinder = viewfinder
        },
                                 dataSourceDelegate: self.delegate)
    }()
